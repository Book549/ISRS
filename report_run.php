...
<div class="report-container">
    <div class="menu-title"><a href="index.php" style="text-decoration: none; color: black;" > กรีฑา</a></div>
    <ul class="table-menu">
        
    <li onclick="toggleMenu('jumen')">ม.1 ชายเดี่ยว</li>
