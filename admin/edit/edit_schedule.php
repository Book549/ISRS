...
<?php 
	if ($_POST['edit_schedule']) {
		...
		$sql_edit_schedule = "UPDATE `schedule` SET `schedule_sport_id`='$schedule_sport_id',`schedule_date`='$schedule_date',`schedule_time`='$schedule_time',`schedule_venue`='$schedule_venue',`schedule_status`='$schedule_status' WHERE `schedule_id`='$schedule_id'";
