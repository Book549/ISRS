...
<div class="report-container">
    <div class="menu-title"><a href="index.php" style="text-decoration: none; color: black;" > วอลเลย์บอล</a></div>
    <ul class="table-menu">
    ...
    <li onclick="toggleMenu('jumen')">ม.ต้น ชาย</li>
       ...
       <li onclick="toggleMenu('womenall')">ม.ต้น หญิง</li>
        ...
        <li onclick="toggleMenu('highmen')">ม.ปลาย ชาย</li>
        ...
        <li onclick="toggleMenu('highmen')">ม.ปลาย หญิง</li>
        <ul id="highmen" class="table-content">
        <table>
                <tr>
                    <th style="width: 10%;">อันดับ</th>
